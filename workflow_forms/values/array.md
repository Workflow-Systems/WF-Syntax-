...
* **Скаляр добавляется в Матрицу**\
  Скаляр из тэга `<Value>` преобразуется в массив с длиной соответствующей наибольшей длине строки матрицы, указанной в тэге `<Source>`_,_ и полученный массив добавляются в конец матрицы или в позицию с индексом из тэга `<Index>`.
...
* **Массив добавляется в Массив**\
  Массив из тэга `<Value>` добавляется в конец массива, указанного в тэге `<Source>` или в позицию с индексом из тэга `<Index>`.
...
* **Скаляр добавляется в Массив**\
  Скаляр из тэга `<Value>` добавляется в конец массива, указанного в тэге `<Source>` или в позицию с индексом из тэга `<Index>`.
...
Так же стоит учитывать момент, когда один из соединяемых массивов возвращает null, то в качестве результат соединения так же будет null.
{% endhint %}
...
#### **Index**  <a href="#select-index" id="select-index"></a>
...
#### **Field** <a href="#select-field" id="select-field"></a>
...
#### **Value** <a href="#select-value" id="select-value"></a>
...
#### **Number** <a href="#select-number" id="select-number"></a>

Подставляет порядковый номер элемента.\
...
#### **Expression** <a href="#select-expression" id="select-expression"></a>
...
#### **Format** <a href="#select-format" id="select-format"></a>

Форматирует элементы массива в строку.\
...
#### **Action** <a href="#select-action" id="select-action"></a>

Элемент на основе вложенного массива.\
...
#### **Substitution** <a href="#select-substitution" id="select-substitution"></a>

Выбор значения из таблицы подстановки.\
