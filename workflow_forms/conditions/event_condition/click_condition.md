...
Список [объектов](../../objects/) формы, клик в которых не вызывает срабатывание события.

Необязательный тэг. Значение тэга `<ExceptObjects>`: список тэгов [`<Object>`](click_condition.md#except_objects_object).

При наличии тэга [`<Object>`](click_condition.md#object) тэг `<ExceptObjects>` игнорируется.
...
[Объект](../../objects/) формы, клик в котором не будет вызывать событие.
