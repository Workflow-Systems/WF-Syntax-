...
**Событийные условия** рассылают уведомления каждый раз когда происходит событие. К ним относятся условия [CellDoubleClickCondition](event_condition/cell_double_click_condition.md), [FormClosingCondition ](event_condition/form_closing_condition.md)и подобные.
{% endhint %}
