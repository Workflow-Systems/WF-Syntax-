---
description: Условный цвет шрифта ячейки.
---

# ForeColor

## Шаблон ForeColor <a href="#template" id="template"></a>
...
1. Тэг [`<Color>`](fore_color.md#color);
2. Тэг [`<ColorFromColumnValue>`](fore_color.md#color_from_column_value);
3. Атрибут [`Name`](fore_color.md#name).

## Атрибуты ForeColor <a href="#attributes" id="attributes"></a>

### Name

Задает имя цвета для шрифта ячейки.

Необязательный атрибут. Ожидается имя одного из цветов, описанных на форме или описание цвета в формате HTML (#rrggbb).

## Тэги ForeColor <a href="#specific-tags" id="specific-tags"></a>
...
Игнорируется, если используется тэг [`<Color>`](fore_color.md#color).&#x20;
